 ...
 * @return array
 */
function wp_recetas_theme_body_classes( $classes ) {
...
add_filter( 'body_class', 'wp_recetas_theme_body_classes' );
 ...
 * @return void
 */
function wp_recetas_theme_pingback_header() {
	if ( is_singular() && pings_open() ) {
		echo '<link rel="pingback" href="', esc_url( get_bloginfo( 'pingback_url' ) ), '">';
	}
}
add_action( 'wp_head', 'wp_recetas_theme_pingback_header' );
