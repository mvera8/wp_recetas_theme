...
add_action('admin_menu', 'wp_recetas_theme_admin');
function wp_recetas_theme_admin() {
  add_menu_page(
  'Recetas Theme',  // Admin page title
  'Recetas Theme',  // Admin menu label
  'manage_options',
  'wp_recetas_theme_options', // Admin slug
  'wp_recetas_theme_page'); // Display Page
}

add_action('admin_init', 'wp_recetas_theme_items');
 ...
 * Display Page
 ***************************************/
function wp_recetas_theme_page() {
?>
    <div class="wrap">  
