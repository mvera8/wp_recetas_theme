...
if ( ! function_exists( 'wp_recetas_theme_setup' ) ) :
	/**
	 ...
	 */
	function wp_recetas_theme_setup() {
		/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on WP_Recetas_Theme, use a find and replace
		* to change 'WP_Recetas_Theme' to the name of your theme in all the template files.
		*/
		load_theme_textdomain( 'WP_Recetas_Theme', get_template_directory() . '/languages' );
...
add_action( 'after_setup_theme', 'wp_recetas_theme_setup' );
 ...
 */
function wp_recetas_theme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'wp_recetas_theme_content_width', 640 );
}

add_action( 'after_setup_theme', 'wp_recetas_theme_content_width', 0 );
